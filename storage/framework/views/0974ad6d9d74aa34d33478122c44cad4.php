        ...
        <div class="row">
            <div class="col-lg-8">
                <article>
                    ...
                    <img src="<?php echo e(asset('images/c1.jpg')); ?>" class="figure-img img-fluid rounded" alt="Hình ảnh xe 1">
                    ...
                    <figure class="figure my-4">
                        <img src="<?php echo e(asset('images/c5.jpg')); ?>" class="figure-img img-fluid rounded"alt="Hình ảnh xe 2">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\P1\XAMPP\htdocs\demogit-master\resources\views/news/index.blade.php ENDPATH**/ ?>